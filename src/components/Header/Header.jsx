    ...
    <header ref={home}>
      <div className='container header__container'>
        ...
        <div className="scroll__down__container" >
          <div className='scroll__down__portfolio scroll__down'><h3 onClick={()=>{scrollTo(portfolio)}}>Portfolio</h3></div>
          <div className='scroll__down scroll__down__arrows' title="scroll down arrows">
            <span onClick={()=>{scrollTo(portfolio)}}>{`>`}</span>
            <span onClick={()=>{scrollTo(portfolio)}}>{`>`}</span>
            <span onClick={()=>{scrollTo(portfolio)}}>{`>`}</span>
            <span onClick={()=>{scrollTo(portfolio)}}>{`>`}</span>
            <span onClick={()=>{scrollTo(portfolio)}}>{`>`}</span>
